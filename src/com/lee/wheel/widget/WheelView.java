...
public class WheelView extends TosGallery {
    ...
    private void initialize(Context context) {
        ...
        this.setOrientation(TosGallery.HORIZONTAL);
        ...
        //this.setBackgroundResource(R.drawable.air_btn_bg_show_bg);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        //drawCenterRect(canvas); 	//no background

        //drawShadows(canvas);		//no background
    }
    ...
    public void setOrientation(int orientation) {
        if (TosGallery.VERTICAL == orientation) {
