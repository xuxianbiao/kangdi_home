...
//	AirConditionDriver m_airCondiDriver = null;
	...
	StateDNRInfoDriver m_StateDNRInfoDriver = null;
...
//		m_airCondiDriver = (R_service==null)?null:(new AirConditionDriver(R_service));;
		...
		m_StateDNRInfoDriver = (R_service==null)?null:(new StateDNRInfoDriver(R_service));
	}
	...
	public IECarDriver R_service = null;
...
//	}
	 ...
	 * @return
	 */
	public StateDNRInfoDriver getStateDNRInfoDriver() {
		return m_StateDNRInfoDriver;
	}
