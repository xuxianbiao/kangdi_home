...
*                                                                      *
*  ideas taken from Langrange.f                                        *
*                                                                      *
*  converted to java by Robyn Wangberg                                 *
*  								       *
************************************************************************/
...
public class InterpolationUtil implements Serializable
{
	 ...
	 */
	public InterpolationUtil(double x[], double y[], boolean allowExtrapolation) {
		if (x != null && y != null) {
	 ...
	 * @param allowExtrapolation True to allow extrapolation.
	 */
	public InterpolationUtil(double x[], double y[], double z[], boolean allowExtrapolation) {
...
//						.getMaximumValue(x_val));
	...
	public double linearInterpolationInLogScale(double x_point) 
	{
		...
		double py = Math.exp(InterpolationUtil.linearInterpolation(x, y, px, allowExtrapolation));
			...
			
	{
		...
		if (greaterX == lowerX) {
			...
			return InterpolationUtil.linearInterpolation(newZ, newY, z_point, allowExtrapolation);			
		}
		...
		for (int i=0; i<np; i++)
		{
			...
			double yy1 = InterpolationUtil.linearInterpolation(lowz, lowy, z, true);			
			double yy2 = InterpolationUtil.linearInterpolation(upz, upy, z, true);
		...
		return InterpolationUtil.linearInterpolation(zz, yy, z_point, allowExtrapolation);			
	}
